...
const ChatWidget: React.FC = () => {
    const { settings, chatHistory, sendChatMessage } = useData();
        ...
        <div className="fixed bottom-6 right-6 z-50">
            ...
            `}>
                <div className="flex-shrink-0 p-4 bg-black/30 border-b border-purple-500/20 flex justify-between items-center">
                    ...
                    <button onClick={() => setIsOpen(false)} className="p-1 rounded-full text-slate-400 hover:bg-slate-700 hover:text-white transition-colors">
